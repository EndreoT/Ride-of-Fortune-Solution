...
def ride(explorer_list: list, switch_list: list, switch_coordinates: dict) -> list:
...
def create_switch_coordinates(array: list) -> dict:
...
def ride_of_fortune(matrix: list, explorers: list) -> list:
    """Main function"""
